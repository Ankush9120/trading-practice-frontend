...
const Register = () => {
  return (
    <form className="registerContainer grow text-white p-6 flex flex-col justify-between gap-2 text-sm my-auto">
      <header className="text-2xl grid gap-1.5">
        <div>
          Welcome
          <span className="text-red-500 font-semibold ml-2.5">Back,</span>
          <span className="font-semibold underline ml-3">Register</span>
        </div>
        <div>
      ...
      <button
        type="submit"
        className="registerBtn btn bg-red-600 mx-auto whitespace-nowrap p-2 w-[14rem] rounded-md myShadow"
      >
        Register
      </button>
        ...
        <button className="TelegramBtn w-14 h-14 btn bg-neutral-700 whitespace-nowrap p-4 rounded-full myShadow flex justify-center gap-[4px]">
          <div className="flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              className="w-full fill-white relative bottom-0.5 right-0.5"
            >
