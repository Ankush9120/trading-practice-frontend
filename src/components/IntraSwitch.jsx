...
import { switchIntra } from "../store/slices/intraSlice";
const IntraSwitch = () => {
  const dispatch = useDispatch();

  const switchIntraMode = () => {
    dispatch(switchIntra());
  };

  return (
    <div
      onClick={switchIntraMode}
      className="intraSwitch absolute rounded-lg rotate-45 bottom-16 right-8 p-1 shadow-xl active:scale-95"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        className="h-8 -rotate-45"
      >
        <path
